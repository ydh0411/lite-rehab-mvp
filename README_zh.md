...
当前测试套件收集 **91 项 Python 测试**，并运行 **4 个 C 主机测试程序**、Python 语法检查、Dashboard checkpoint 冒烟测试和两套 ESP-IDF 构建。BLE、摄像头、CJMCU-8232/电极、OLED、LED 和蜂鸣器仍需按 [DEMO_GUIDE.md](DEMO_GUIDE.md) 在真实硬件上验收。
